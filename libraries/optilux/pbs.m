...
%
%   EX.field(:,1) = ( xpol - ypol ) /sqrt(2);
%   EX.field(:,2) = 0;
%   EY.field(:,1) = 0;
%   EY.field(:,2) = ( xpol + ypol ) /sqrt(2);
%
%   where xpol contains the x-polarization samples, hence it is
%   EX.field(:,1:2:end). Similarly, ypol is EY.field(:,2:2:end).
%
...
%   polarization along y, but, as a consequence of the above operations, a 
%   phase shift of pi is added on EX because of the unitarity of the 45 
%   degree transformation.
%
%   See also: LASERSOURCE, PBC.
%
%   Author: Paolo Serena, 2022
